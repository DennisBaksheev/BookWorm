...
const connectDB = async () => {
  try {
    const conn = await mongoose.connect(process.env.MONGO_ATLAS_PASSKEY, {useNewUrlParser: true});
  } catch (error) {
    console.log(error);
    process.exit(1);
  }
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: "http://localhost:3000/auth/google/callback", // Update this line
